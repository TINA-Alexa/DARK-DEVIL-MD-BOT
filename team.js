...
module.exports = RedDragonMdNx = async (RedDragonMdNx, m, chatUpdate, store) => {
    try {
        ...
        const pushname = m.pushName || "🔴 *𝐁𝐨𝐭 𝐎𝐧𝐥𝐢𝐧𝐞 𝐍𝐎𝐖* ‼️"
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await RedDragonMdNx.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, RedDragonMdNx, [{"urlButton": {"displayText": `${button}`,"url": `${btnurl}`}}])
  }
  break
        case 'userlimit': 
{      
...
case 'webtonsearch': case 'webtoon':
            ...
            case 'animexxx':{
				...
				await RedDragonMdNx.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(mess.error)
                })
	    ...
	    case 'couplepp':  case 'ppcouple': {
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                RedDragonMdNx.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male🙎🏻‍♂️` }, { quoted: m })
                RedDragonMdNx.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female🙎🏻‍♀️` }, { quoted: m })
            }
	    break
...
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    ...
                    case 'bot': case 'alive': case 'menu': case 'list':
                        ...
                        var unicorn = await getBuffer('./data.1freewallpapers.com/download/samantha-hot-1600x900.jpg')
                        ...
                        latensie = speed() - timestampe
                            ...
                            let buttonMessage = {
                                image: fs.readFileSync('./data.1freewallpapers.com/download/samantha-hot-1600x900.jpg'),
                                caption: `╔●●🔥${botname}\n▌ ╠ Hi, ${pushname} ╣\n╚●●●❖╠👨‍💻_𝐈 𝐚𝐦 𝐀𝐥𝐢𝐯𝐞_👨‍💻╣\n▌⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀:\n▌❮✮❯ 𝘽𝙤𝙩 𝙉𝙖𝙢𝙚 :${global.botname}\n▌❮✮❯ 𝙊𝙬𝙣𝙚𝙧 𝙉𝙖𝙢𝙚 :${global.ownername}\n▌❮✮❯ 𝙊𝙬𝙣𝙚𝙧 𝙉𝙪𝙢𝙗𝙚𝙧 :${global.owner}\n▌❮✮❯ 𝙎𝙥𝙚𝙚𝙙 : ${latensie.toFixed(4)} miliseconds\n▌❮✮❯ 𝙋𝙡𝙖𝙩𝙛𝙤𝙧𝙢 : ${os.platform()}\n▌⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀⦀:\n${global.alivemsg}\n╗\n${global.namedd}\n❯❯●●●●●●●●●●     ●●●●●●●●●●❮❮`,
                                footer: RedDragonMdNx.user.name,
                                buttons: buttons,
                                headerType: 4
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
            ...
            break
            case 'sc': case 'script': {
                reply(`GitHub : 🫡අන්තරස් දහන්...ඒස්වා පුහ්!!🫡\n Dont Forget To Give Star\n\nGITHUB : ${btnurl}\n Dont Forget To Follow Me`)
            }
            break
...
┃╠💆‍♂️ thunder [txt]
┃╠💆‍♂️ magma [txt]
┃╠💆‍♂️ 3dcrackedstone [txt]
┃╠💆‍♂️ 3dneonlight [txt]
┃╠💆‍♂️ impressiveglitch [txt]
┃╠💆‍♂️ naturalleaves [txt]
┃╠💆‍♂️ fireworksparkle [txt]
┃╠💆‍♂️ matrix [txt]
┃╠💆‍♂️ dropwater [txt]
┃╠💆‍♂️ harrypotter [txt]
┃╠💆‍♂️ foggywindow [txt]
┃╠💆‍♂️ neondevils [txt]
┃╠💆‍♂️ christmasholiday [txt]
┃╠💆‍♂️ 3dgradient [txt]
┃╠💆‍♂️ blackpink [txt]
┃╠💆‍♂️ gluetext [txt]
┃║
...
┃║
┃╚═══════✍︎☬
┗━❯ *Created By 💆‍♂️#𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙_𝚋𝚘𝚝 24/7💆‍*`,
                footer: RedDragonMdNx.user.name,
                buttons,
                headerType: 4
                }
